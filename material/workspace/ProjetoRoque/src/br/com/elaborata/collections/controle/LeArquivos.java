...
public class LeArquivos {
	...
	public Collection<Funcionario> listarFuncionario() throws NumberFormatException, IOException {
		...
		while (entrada.ready()) {
			...
			funcionario.setEndereco(array[2]);
			funcionario.setCidade(cidade);
			funcionario.setEstado(array[4]);
			funcionario.setPais(array[5]);
	...
	public void salvarFuncionarios(Collection<Funcionario> funcionarios) {
		...
		try {
			...
			for (Funcionario funcionario : funcionarios) {
				...
				sb.append(",");
				sb.append(funcionario.getEndereco());
				sb.append(",");
				sb.append(funcionario.getCidade().getNome());
				sb.append(",");
				sb.append(funcionario.getEstado());
				sb.append(",");
				sb.append(funcionario.getPais());
				sb.append("\n");
